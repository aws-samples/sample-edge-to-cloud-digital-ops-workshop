...
| **Iceberg / Athena** | Historical only | Athena console — no front-end route | Console only | ~30–90 s floor |
...
| **Iceberg / Athena** | ~30–90 s | ~30–120 s *(scan size grows with data volume)* |
